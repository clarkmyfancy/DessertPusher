...
class DessertTimer(lifecycle: Lifecycle) : LifecycleObserver {
    ...
    init {
        // says that this class, hence 'this' used below, is going to be the observer of the MainActivity
        lifecycle.addObserver(this)
    }

    // this annotation says that whenever the observer (this) sees that the main activcity has
        // done the onpause thing, this dummy method will be caled
